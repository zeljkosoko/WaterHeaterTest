...
namespace WaterHeaterTest.Migrations
{
    ...
    [Migration("20230228095218_Agr_AktElektroispravnost_SifElektropult_Model")]
    partial class Agr_AktElektroispravnost_SifElektropult_Model
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WaterHeaterTest.Models.Agr_AktElektroispravnostBojler_SifElektropult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("IdAktElektroispravnostBojler")
                        .HasColumnType("int");

                    b.Property<int>("IdSifElektropult")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.ToTable("Agr_AktElektroispravnostBojler_SifElektropult");
                });
            ...
            modelBuilder.Entity("WaterHeaterTest.Models.SifArtikal", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("Sif_Artikal");
                });

            modelBuilder.Entity("WaterHeaterTest.Models.SifElektropult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WaterHeaterTest.Models.TEST_RESULTS", b =>
                {
                    ...
                    b.Property<int?>("Sif_Serijski_Broj_BojlerId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Sif_Serijski_Broj_BojlerId");
            ...
            modelBuilder.Entity("WaterHeaterTest.Models.TEST_RESULTS", b =>
                {
                    ...
                    b.HasOne("WaterHeaterTest.Models.Sif_Serijski_Broj_Bojler", "Sif_Serijski_Broj_Bojler")
                        .WithMany()
                        .HasForeignKey("Sif_Serijski_Broj_BojlerId");
                });
